...
const Country = () => {
  ...
  return (
    ...
    <form className='text-center'>
      <h1 className='text-6xl mt-6 m-8 font-bold uppercase'>Country </h1>
      <input type="text" placeholder='Searching' className='border-2 p-2 w-[30%] m-2' /> <br />
      <input type="text" placeholder='CountryName' className='border-2 p-2 w-[30%] m-2' />
      <input type="number" placeholder='RegionId' className='border-2 p-2 w-[30%] m-2' /><br />
