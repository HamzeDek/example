...
const Emplooyee = () => {
  ...
  return (
    ...
    <form className='text-center'>
      <h1 className='text-6xl mt-6 m-8 font-bold uppercase'>Emplooyee </h1>
      <input type="number" placeholder='Searching' className='border-2 p-2 w-[30%] m-2' /> <br />
      <input type="text" placeholder='FirstName' className='border-2 p-2 w-[30%] m-2' />
