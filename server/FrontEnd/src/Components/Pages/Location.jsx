...
const Location = () => {
  ...
  return (
    ...
    <form className='text-center'>
      <h1 className='text-6xl mt-6 m-8 font-bold uppercase'>Location </h1>
      <input type="number" placeholder='Searching' className='border-2 p-2 w-[30%] m-2' /> <br />
      <input type="text" placeholder='Address' className='border-2 p-2 w-[30%] m-2' />
      <input type="text" placeholder='State' className='border-2 p-2 w-[30%] m-2' /><br />
      <input type="text" placeholder='PostCode' className='border-2 p-2 w-[30%] m-2' />
